        ...
        child: Column(
          ...
          children: [
            ...
            CarbonCompactButton(
              ...
              onTap: _booking ? null : () => _book(_BookingChannel.none),
            ),
            if (_hasPhone || _hasEmail) ...[
              ...
              if (_hasPhone) ...[
                CarbonCompactButton(
                  ...
                  style: CarbonButtonStyle.secondary,
                  onTap: _booking ? null : () => _book(_BookingChannel.phone),
                ),
                const SizedBox(height: 8),
              ],
              if (_hasEmail) ...[
                CarbonCompactButton(
                  ...
                  style: CarbonButtonStyle.secondary,
                  onTap: _booking ? null : () => _book(_BookingChannel.email),
                ),
                const SizedBox(height: 8),
              ],
              if (_hasPhone)
                CarbonCompactButton(
                  ...
                  style: CarbonButtonStyle.secondary,
                  onTap: _booking ? null : () => _book(_BookingChannel.text),
                ),
            ],
            const SizedBox(height: 24),
          ],
